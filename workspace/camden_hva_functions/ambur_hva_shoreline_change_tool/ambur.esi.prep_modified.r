...
ifelse(colnames(tet3) == "StartX", tet3$Start_X <- tet3$StartX,   tet3$StartX <- tet3$StartX)
ifelse(colnames(tet3) == "StartY", tet3$Start_Y <- tet3$StartY,   tet3$StartY <- tet3$StartY)
