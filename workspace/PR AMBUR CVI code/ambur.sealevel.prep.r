...
tkmessageBox(message = "Please select the shoreline sea level shapefile...")
...
outputdata <- SpatialLinesDataFrame(out,tet3)
 ...
 writeOGR(outputdata, ".", "ambur_sea_level_lines_all", driver="ESRI Shapefile") 
...
writeOGR(lns.output, ".", "ambur_hva_sealevel_lns", driver="ESRI Shapefile")
