...
colnames(tet3) <- gsub("Start_X", "StartX", colnames(tet3))
colnames(tet3) <- gsub("End_X", "EndX", colnames(tet3))
colnames(tet3) <- gsub("Start_Y", "StartY", colnames(tet3))
colnames(tet3) <- gsub("End_Y", "EndY", colnames(tet3))
colnames(tet3) <- gsub("T_azimuth", "Azimuth", colnames(tet3))
colnames(tet3) <- gsub("Base_Loc", "BASE_LOC", colnames(tet3))
...
writeOGR(outputdata, ".", "transect_captured_pts", driver="ESRI Shapefile")
