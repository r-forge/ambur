...
writeOGR(lns.output, ".", "ambur_composite_all_transects", driver="ESRI Shapefile")
...
writeOGR(pts.output, ".", "ambur.composite_all_pts", driver="ESRI Shapefile")
